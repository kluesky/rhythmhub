  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="aspect-video rounded-[1.8rem] overflow-hidden border border-white/5 relative bg-[#0f111a]">
          <img 
            ...
            alt={game.name} 
            className={`w-full h-full object-cover transition-transform duration-700 ${isMaintenance ? 'grayscale opacity-50' : 'group-hover:scale-105'}`}
          />
            ...
            <div className="flex gap-4 border-y border-white/5 py-3">
              ...
              <div className="flex flex-col gap-1 flex-1">
                ...
                <span className={`text-[10px] font-bold uppercase truncate ${
                  ...
                  {isMaintenance ? 'Maintenance' : isHighRisk ? 'High Risk' : 'Online Stable'}
                </span>
              </div>
            </div>
          </div>
      ...
      <button 
        ...
        className={`w-full mt-8 font-black py-4 rounded-2xl text-[10px] uppercase tracking-[0.3em] transition-all group/btn shadow-xl ${
          isMaintenance 
