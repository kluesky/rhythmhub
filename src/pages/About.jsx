        ...
        >
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-blue-950/30 rounded-full px-4 py-1.5 mb-4 border border-blue-800">
              <span className="text-xs text-blue-400 font-medium">Tentang Kami</span>
            </div>
          ...
          <div className="bg-gray-900 rounded-xl shadow-sm border border-gray-800 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-8">
              <h2 className="text-2xl font-bold text-white mb-2">#1 Rhythm Game MOD Hub</h2>
              <p className="text-blue-200">Koleksi MOD APK game rhythm pilihan dengan fitur premium</p>
            </div>
            ...
            <div className="p-6 space-y-6">
              {/* Apa Itu RhythmHub */}
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">🎯 Apa Itu RhythmHub?</h3>
                <p className="text-gray-400 leading-relaxed">
                  RhythmHub adalah platform khusus yang menyediakan kumpulan MOD APK dari game-game rhythm terbaik. 
                  Kami menghadirkan fitur-fitur premium seperti <span className="font-medium text-blue-400">Always Perfect</span>, 
                  <span className="font-medium text-blue-400"> Auto Dance</span>, <span className="font-medium text-blue-400">God Mode</span>, 
                  dan berbagai fitur eksklusif lainnya yang <span className="font-semibold text-white">TIDAK tersedia</span> di versi original.
                </p>
              </div>

              {/* Fitur MOD yang Tersedia */}
              <div>
                <h3 className="text-lg font-semibold text-white mb-3">⚡ Fitur MOD yang Tersedia</h3>
              ...
              {/* Game yang Didukung */}
              <div>
                <h3 className="text-lg font-semibold text-white mb-3">🎮 Game yang Didukung</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">📥 Cara Mendapatkan MOD</h3>
              ...
              {/* Request Game */}
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">📝 Request Game Baru</h3>
                <p className="text-gray-400 text-sm mb-2">
                  Game rhythm favoritmu belum tersedia? Langsung request melalui halaman 
                  <span className="font-medium text-blue-400"> Request Game</span>.
                </p>
              ...
              <div className="bg-yellow-950/30 border border-yellow-800 rounded-lg p-4">
                <h3 className="text-sm font-semibold text-yellow-400 mb-2">⚠️ Disclaimer Penting</h3>
                <ul className="text-xs text-yellow-500 space-y-1 list-disc list-inside">
              ...
              <div className="border-t border-gray-800 pt-4">
                <h3 className="text-sm font-semibold text-white mb-2">📞 Kontak & Dukungan</h3>
                <p className="text-xs text-gray-500">
                  Untuk pertanyaan, laporan bug, atau request game, silakan gunakan halaman Request Game.
                </p>
              </div>
